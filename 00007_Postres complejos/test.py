  ...
  def test_el_flan_casero_es_mas_dificil_de_cocinar_que_el_cheesecake(self):
    self.assertEqual(mas_dificil_de_cocinar(self.flan_casero, cheesecake), self.flan_casero)
  ...
  def test_si_dos_postres_son_igual_de_dificiles_de_cocinar_devuelve_cualquiera_de_los_dos(self):
    mas_dificil = mas_dificil_de_cocinar(self.flan_casero, lemon_pie)
    self.assertTrue(mas_dificil == self.flan_casero or mas_dificil == lemon_pie)